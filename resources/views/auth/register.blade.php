...
<head>
	@include('inc-meta')
    <title>JFRL | Inscription enseignant</title>
</head>
<body>
...
<div class="container mt-4 mb-5">
		<div class="row">
			...
			<div class="col-md-11">
				...
				<h1 class="m-0">Inscription</h1>
				<div class="text-monospace small">Création d'un compte enseignant pour inscrire des élèves comme intervenants ou auditeurs (en présentiel ou en distanciel).</div>
