	...
	<div class="container mt-4">
		...
		<div class="row">
			<div class="col-md-6">
				...
				<div class="titre-1 text-danger">JOURNÉE FRANCOPHONE<br /> DE LA RECHERCHE</div>
				<div class="titre-2 text-dark">des lycéen(ne)s</div>	
				<div class="text-right text-secondary text-monospace small mt-3"><b>décembre 2025</b></div>	
				...
				<div class="text-right mt-4">
					...
					<a class="btn btn-primary" href="/inscription_enseignant" role="button" style="width:120px;">inscription</a>
					<br />
		...
		<div class="row mt-4">
			<div class="col-md-10 offset-md-1" style="font-family: 'Latin Modern Roman', serif;font-size:20px;text-align:justify;">			
				...
				<div class="pt-5">
					...
					<ul>
						<li><b class="text-monospace text-success" style="font-size:90%">début novembre 2025</b> : fin des dépôts des propositions de présentations</li>
						<li><b class="text-monospace" style="font-size:90%">début novembre ~ mi-novembre 2025</b> : étude des dossiers</li>
						<li><b class="text-monospace" style="font-size:90%">mi-novembre 2025</b> : publication du programme de la JFRL 2025</li>
						<li><b class="text-monospace text-primary" style="font-size:90%">décembre 2025</b> : JFRL 2025</li>
					</ul>
				</div>
				...
				<div class="pt-3">
					...
					<div>
						...
						<ul>
							<li>s'inscrire sur le site de la JFRL: <a href="https://www.jfrl.org">www.jfrl.org</a></li>
